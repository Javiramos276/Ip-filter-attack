...
Este script acepta **formatos de lectura como archivos de texto y tambien archivos comprimidos de tipo .gz**, simplemente suelta los archivos de tu interes en la carpeta donde se encuentra el archivo main.py
...
Ejecuta ```python main.py``` para comenzar la busqueda. Deberás pasarle al programa un **USER-AGENT** (dentro de la lista de archivos que quieras inspeccionar), como puede ser por ejemplo: ```Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36 OPR/105.0.0.0```
